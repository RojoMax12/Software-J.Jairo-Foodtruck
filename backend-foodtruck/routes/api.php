...
// ==========================================
// 2. RUTAS PÚBLICAS PARA MENÚ QR Y PEDIDOS DE CLIENTES (RATE LIMITED)
// ==========================================
Route::prefix('public')->group(function () {
    ...
    Route::post('/pedidos', [PedidoPublicoController::class, 'storePublico'])->middleware('throttle:api_escritura');
});
Route::get('/horarios/turno-actual', [HorarioAtencionController::class, 'getTurnoActual'])->middleware('throttle:api_lectura');
...
// ==========================================
Route::middleware('jwt.auth')->group(function () {
    Route::post('/pedidos', [PedidoController::class, 'store'])->middleware('throttle:api_escritura');
    Route::get('/pedidos/mis-pedidos', [PedidoController::class, 'getMisPedidos'])->middleware('throttle:api_lectura');
    Route::get('/pedidos/{id}/usuario_distribuidor', [PedidoController::class, 'getPedidosByUsuario'])->middleware('throttle:api_lectura');
    Route::get('/pedidos/usuario/{id}', [PedidoController::class, 'getPedidosByUsuario'])->middleware('throttle:api_lectura');
});
